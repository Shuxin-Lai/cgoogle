<template>
  <div class="flex flex-col gap-4">
    ...
    >
      <input min="0" max="10" type="number" class="input-bordered input w-full" />
    </c-form-item>
    ...
    >
      <input min="0" max="1" type="number" class="input-bordered input w-full" />
    </c-form-item>
    ...
    <c-form-item>
      <template #label>
        <div class="flex w-full">
          ...
          <div class="tooltip tooltip-left tooltip-primary" data-tip="Add a \n">
            <kbd class="kbd kbd-sm cursor-pointer">
      ...
      <div class="flex">
        <input class="input-bordered input flex-1" />
        <button class="btn-outline btn hover:bg-transparent hover:text-black">Add</button>
      </div>
    </c-form-item>
  </div>
</template>
